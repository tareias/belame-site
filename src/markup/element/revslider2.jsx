                                ...
                                <div id="welcome" className="rev_slider fullscreenbanner" style={{ "display": "none" }} data-version="5.4.7.2">
                                    <ul>
                                        ...
                                        <li data-index="rs-101" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                            {/* <!-- MAIN IMAGE --> */}
                                            <img src="images/main-slider/dummy.png" alt="" data-lazyload="images/main-slider/slide4.jpg" data-bgposition="center center" data-kenburns="on" data-duration="4000" data-ease="Power3.easeInOut" data-scalestart="150" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="4" className="rev-slidebg" data-no-retina />
                                            {/* <!-- LAYERS --> */}
                                            ...
                                            <div className="tp-caption tp-shape tp-shapewrapper ov-tp "
                                                ...
                                                style={{ "zIndex": "5", "fontFamily": "Open Sans" }}> </div>
                                            ...
                                            <div className="tp-caption  "
                                                ...
                                                style={{ "zIndex": "6", "minWidth": "800px", "maxWidth": "800px", "whiteSpace": "normal", "fontSize": "90px", "lineHeight": "90px", "fontWeight": "600", "color": "#ffffff", "letterSpacing": "-5px", "fontFamily": "'Montserrat',sans-serif" }}>Design Agency</div>
                                            ...
                                            <div className="tp-caption  "
                                                ...
                                                style={{ "zIndex": "7", "minWidth": "640px", "maxWidth": "640px", "whiteSpace": "normal", "fontSize": "20px", "lineHeight": "30px", "fontWeight": "400", "color": "rgba(255,255,255,0.75)", "fontFamily": "'Montserrat',sans-serif" }}>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</div>

                                            {/* <!-- LAYER NR. 4 --> */}
                                            <Link className="tp-caption rev-btn   tc-btnshadow tp-rs-menulink"
                                                href="#" target="_blank"
                                                ...
                                                style={{ "zIndex": "8", "minWidth": "280px", "maxWidth": "280px", "whiteSpace": "nowrap", "fontSize": "17px", "lineHeight": "60px", "fontWeight": "500", "color": "rgba(255,255,255,1)", "fontFamily": "'Montserrat',sans-serif", "borderRadius": "30px 30px 30px 30px", "outline": "none", "boxSizing": "border-box", "MozBoxSizing": "border-box", "WebkitBoxSizing": "border-box", "cursor": "pointer", "textDecoration": "none" }}><i className="fa-icon-cube" style={{ "fontSize": "17px", "marginRight": "5px" }}></i> About Us </Link>

                                            {/* <!-- LAYER NR. 5 --> */}
                                            <Link className="tp-caption rev-btn   tc-btnshadow"
                                                href="#" target="_blank"
                                                ...
                                                style={{ "zIndex": "9", "minWidth": "280px", "maxWidth": "280px", "whiteSpace": "nowrap", "fontSize": "17px", "lineHeight": "60px", "fontWeight": "500", "color": "#000", "fontFamily": "'Montserrat',sans-serif", "backgroundColor": "#fff", "borderRadius": "30px 30px 30px 30px", "outline": "none", "boxSizing": "border-box", "MozBoxSizing": "border-box", "WebkitBoxSizing": "border-box", "cursor": "pointer", "textDecoration": "none" }}><i className="fa-icon-cloud-download" style={{ "fontSize": "17px", "marginRight": "5px" }}></i> Read More </Link>
                                        </li>
                                        {/* <!-- SLIDE  --> */}
                                        <li data-index="rs-102" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                            ...
                                            <div className="tp-caption  "
                                                ...
                                                style={{ "zIndex": "6", "minWidth": "800px", "maxWidth": "800px", "whiteSpace": "normal", "fontSize": "90px", "lineHeight": "90px", "fontWeight": "600", "color": "#ffffff", "letterSpacing": "-5px", "fontFamily": "'Montserrat',sans-serif" }}>Creative Studio </div>
